...
import 'rider_review_dialog_model.dart';

class RiderReviewDialog extends StackedView<RiderReviewDialogModel> {
  ...
  @override
  Widget builder(
      BuildContext context, RiderReviewDialogModel viewModel, Widget? child) {
  ...
  @override
  RiderReviewDialogModel viewModelBuilder(BuildContext context) =>
      RiderReviewDialogModel();
}
