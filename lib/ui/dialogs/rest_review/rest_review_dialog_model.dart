...
class RestReviewDialogModel extends BaseViewModel {
  double rating = 0.0;
  ...
  submitReview(context, orderId, restaurantId) async {
    setBusy(true);
    final res = await _dbService.submitReviewForRest(
        orderId, restaurantId, rating, controller.text);
    if (res.success) {
